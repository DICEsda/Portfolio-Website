...
const Contact = () => {
  ...
  return (
    <section id="contact" ref={sectionRef} className="h-[75vh] flex items-center justify-center py-8 scroll-snap-align-start">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="max-w-xl mx-auto">
          ...
          <div className={`mt-6 flex justify-center space-x-8 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
            {socialLinks.map((link, index) => (
              <a
                ...
                className="text-tertiary hover:text-secondary transition-all duration-300 p-2 hover:scale-110 hover:-translate-y-1"
