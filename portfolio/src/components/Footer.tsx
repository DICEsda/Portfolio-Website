        ...
        <AnimatePresence mode="wait" initial={false}>
          {isAtLastSection ? (
            <motion.div
              ...
              className="flex gap-6 bg-primary/70 backdrop-blur-md border border-tertiary/10 rounded-full px-5 py-2 shadow-md pointer-events-auto"
            ...
            >
              <a
                ...
                className="text-secondary/90 hover:text-secondary transition-colors"
                aria-label="GitHub"
              >
            ...
            <motion.p
              ...
              exit={{ opacity: 0, y: 8 }}
              transition={{ duration: 0.25 }}
              className="text-tertiary/90 text-xs md:text-sm bg-primary/70 backdrop-blur-md border border-tertiary/10 rounded-full px-4 py-1.5 shadow-md pointer-events-auto"
            >
